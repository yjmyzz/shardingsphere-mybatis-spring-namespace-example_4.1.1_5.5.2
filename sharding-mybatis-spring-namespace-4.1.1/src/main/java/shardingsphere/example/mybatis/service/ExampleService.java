...
public final class ExampleService {
    ...
    private void printData() throws SQLException {
        ...
        LOGGER.info("---------------------------- Print Order Data：t_order_vip -----------------------");
        for (Object each : this.selectVipOrder()) {
            LOGGER.info(each.toString());
        }
    }

    private List<Order> selectVipOrder() throws SQLException {
        List<Order> result = orderRepository.selectVipOrder();
        return result;
    }
